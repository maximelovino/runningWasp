...
public class RunDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(RunDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(RunDetailFragment.ARG_ITEM_ID));
            RunDetailFragment fragment = new RunDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.run_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, RunListActivity.class));
            return true;
        }
